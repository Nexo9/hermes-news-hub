...
const SimpleMapEnhanced = () => {
  ...
  const filteredNews = useMemo(() => {
    return news.filter(item => {
      ...
      const matchesCategory = categoryFilter === "Toutes" || 
  ...
  return (
    <div className="relative w-full h-full bg-[#0a1628] overflow-hidden">
      {/* Top Navigation Bar */}
      <div className="absolute top-0 left-0 right-0 z-30 bg-background/95 backdrop-blur-md border-b border-border">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold">Carte des Actualités</h1>
          </div>

          {/* Right: Stats */}
          <Badge variant="outline" className="bg-primary/10 border-primary/30">
            {filteredNews.length} news · {locationGroups.length} lieux
          </Badge>
        </div>
        ...
        <div className="flex items-center gap-3 px-4 pb-3">
          <div className="relative flex-1 max-w-md">
            ...
            <Input
              placeholder="Rechercher un lieu ou une actualité..."
              value={searchQuery}
      ...
      {/* Map Container */}
      <div 
        className="absolute inset-0 pt-28 cursor-grab active:cursor-grabbing"
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* NORTH AMERICA */}
            <path d="M5,28 Q10,22 18,20 Q25,18 32,24 L35,30 Q34,35 30,40 L28,48 Q22,55 15,52 L10,48 Q5,42 4,35 L5,28" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.3" filter="url(#glow)" />
            <path d="M5,20 Q8,18 12,19 L10,24 Q6,23 5,20" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            <path d="M35,15 Q42,12 45,18 L43,25 Q38,28 35,23 L35,15" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            
            {/* CENTRAL AMERICA */}
            <path d="M18,52 Q22,54 20,58 L18,60 Q15,58 16,55 L18,52" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            
            {/* SOUTH AMERICA */}
            <path d="M22,60 Q28,58 32,62 L35,70 Q34,78 30,82 L26,80 Q22,76 24,70 L22,60" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.3" filter="url(#glow)" />
            
            {/* EUROPE */}
            <path d="M42,30 Q48,28 54,30 L58,34 Q56,40 52,42 L48,44 Q44,42 42,38 L42,30" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.3" filter="url(#glow)" />
            <path d="M42,32 Q44,30 45,33 L44,36 Q42,35 42,32" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            <path d="M50,22 Q54,20 56,25 L54,32 Q52,30 50,26 L50,22" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            
            {/* AFRICA */}
            <path d="M44,46 Q52,44 58,48 L62,55 Q60,68 55,75 L48,78 Q44,74 45,65 L44,55 L44,46" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.3" filter="url(#glow)" />
            <path d="M62,68 Q64,66 65,70 L63,74 Q61,72 62,68" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            
            {/* ASIA */}
            <path d="M58,26 Q70,22 82,28 L88,35 Q90,45 85,52 L78,58 Q70,60 65,54 L60,46 Q58,38 58,26" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.3" filter="url(#glow)" />
            <path d="M58,44 Q62,42 66,46 L64,52 Q60,50 58,48 L58,44" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            <path d="M66,48 Q72,46 74,52 L72,60 Q68,58 66,54 L66,48" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            <path d="M86,38 Q88,36 89,40 L88,46 Q86,44 86,38" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            
            {/* SOUTHEAST ASIA */}
            <path d="M76,60 Q82,58 86,62 L88,66 Q84,68 78,66 L76,60" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
            
            {/* AUSTRALIA */}
            <path d="M78,68 Q88,66 92,72 L90,80 Q84,82 80,78 L78,72 L78,68" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.3" filter="url(#glow)" />
            <path d="M94,78 Q96,76 96,80 L95,84 Q93,82 94,78" fill="url(#landGradient)" stroke="#2a4a70" strokeWidth="0.2" />
      ...
      {/* Legend */}
      <div className="absolute bottom-4 left-4 bg-background/90 backdrop-blur-md rounded-xl p-3 border border-primary/30 shadow-lg z-20">
        <p className="text-xs text-muted-foreground mb-2 font-medium">Légende</p>
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 rounded-full bg-gradient-to-br from-primary via-purple-500 to-blue-500 flex items-center justify-center text-white text-[8px] font-bold">
            N
          </div>
          <span className="text-xs text-muted-foreground">Actualités par zone</span>
        </div>
        <p className="text-[10px] text-muted-foreground mt-1 opacity-70">Glissez pour naviguer</p>
      </div>
      ...
      <AnimatePresence>
        {selectedLocation && !selectedNews && (
          <motion.div
            ...
            className="absolute right-0 top-28 bottom-0 w-full sm:w-96 bg-background/98 backdrop-blur-md border-l border-primary/30 z-30"
          >
      ...
      <AnimatePresence>
        {selectedNews && (
          <motion.div
            ...
            exit={{ x: "100%", opacity: 0 }}
            transition={{ type: "spring", stiffness: 300, damping: 30 }}
            className="absolute right-0 top-28 bottom-0 w-full sm:w-[28rem] bg-background/98 backdrop-blur-md border-l border-primary/30 z-30"
          >
            <Card className="h-full rounded-none border-0 bg-transparent">
              <CardHeader className="pb-2 border-b border-border/50">
                <div className="flex items-center justify-between">
              ...
              <CardContent className="p-4">
                ...
                <ScrollArea className="h-[calc(100vh-400px)]">
                  ...
                  <div className="space-y-2 mb-6">
                    ...
                    {selectedNews.source_urls.map((url, idx) => (
                      <a
                        key={idx}
                        href={url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 text-xs text-primary hover:underline p-2 rounded-lg bg-primary/5 hover:bg-primary/10 transition-colors"
                      >
...
export default SimpleMapEnhanced;
